...
joblib.dump(lreg, 'Multiple_Linear_Regression')
...
for i in range(5):
    ...
    ax.plot(X_test[:, i], lreg.predict(X_test), color='red')
...
# Saving model into a file
joblib.dump(poly_model, 'Polynomial_Regression')
...
# Saving model into a file
joblib.dump(lasso, 'Lasso_Regression')
...
# Saving model into a file
joblib.dump(e_net, 'Elastic_Regression')
...
# Saving model into a file
joblib.dump(ridgeR, 'Ridge_Regression')
